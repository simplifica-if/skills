...
def round_paths(rodada_dir: Path) -> dict[str, Path]:
    ...
    return {
        ...
        "ppc": rodada_dir / "PPC.md",
        "ppc_bruto": rodada_dir / "PPC-bruto.md",
        "metadata": rodada_dir / "metadata.json",
        "manifesto": rodada_dir / "manifesto-rodada.json",
        "preparacao_docx": rodada_dir / "preparacao-docx.json",
        "pre_validacoes": rodada_dir / "pre-validacoes.json",
        "condicionais_rodada": rodada_dir / "condicionais-rodada.json",
        "contexto_estrutural": rodada_dir / "contexto-estrutural.json",
        "cnct_comparacao": rodada_dir / "cnct-comparacao.json",
        "validacoes_cruzadas": rodada_dir / "validacoes-cruzadas.json",
        "validacoes_cruzadas_status": rodada_dir / "validacoes-cruzadas.status.json",
        "validacoes_cruzadas_prompt": rodada_dir / "validacoes-cruzadas.prompt.md",
        "validacoes_cruzadas_resposta_bruta": rodada_dir / "validacoes-cruzadas.resposta-bruta.md",
        "validacoes_cruzadas_catalogo": rodada_dir / "validacoes-cruzadas.catalogo.json",
        "execucoes_avulsas_dir": rodada_dir / "execucoes-avulsas",
        "execucoes_avulsas_fichas_dir": rodada_dir / "execucoes-avulsas" / "fichas",
        "execucoes_avulsas_validacoes_dir": rodada_dir / "execucoes-avulsas" / "validacoes-cruzadas",
        "sobreposicoes_fichas": rodada_dir / "execucoes-avulsas" / "sobreposicoes-fichas.json",
        "sobreposicoes_validacoes_cruzadas": rodada_dir / "execucoes-avulsas" / "sobreposicoes-validacoes-cruzadas.json",
        "uso_tokens": rodada_dir / "uso-tokens.json",
        "batches_dir": rodada_dir / "batches",
        "resultados_dir": rodada_dir / "resultados-lotes",
        "resultados_fichas": rodada_dir / "resultados-fichas.json",
        "achados": rodada_dir / "achados.json",
        "parecer_final": rodada_dir / "parecer-final.json",
